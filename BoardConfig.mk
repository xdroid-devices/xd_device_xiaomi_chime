...
# Assert
TARGET_OTA_ASSERT_DEVICE := citrus,lime,lemon,pomelo,juice
...
# Init
TARGET_INIT_VENDOR_LIB := //$(DEVICE_PATH):init_juice
...
BOARD_KERNEL_CMDLINE += loop.max_part=7 androidboot.fstab_suffix=default
